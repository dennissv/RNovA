...
class RnovaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        node_mass, node_intensity_log, peak_intensity_rank, node_class, peak_moverz = self.spectrum_preprocess(product_ion_moverz, product_ion_intensity_log, product_ion_rank, precursor_mass, precursor_charge, precursor_moverz)
    ...
    def spectrum_preprocess(self, product_ion_moverz, product_ion_intensity, product_ion_rank, precursor_mass, precursor_charge, precursor_moverz):
        ...
        return node_mass, node_intensity, peak_intensity_rank, node_class, peak_moverz
