...
`rnova setup` compiles the Cython component by running:
...
```bash
python Inference_Sequence.py input1.mgf input2.mgf ... inputN.mgf "A;C|UniMod:4;D;E;F;G;H;K;L;M;N;P;Q;R;S;T;V;W;Y;M|UniMod:35;W|UniMod:351"
```
...
The output filename will be the original filename with `_rnova_denovo_seq.csv` appended.
